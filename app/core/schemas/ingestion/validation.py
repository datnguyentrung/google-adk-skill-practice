...
class ValidationCode(StrEnum):
    ...
    ONTOLOGY_CARDINALITY_VIOLATION = "ONTOLOGY_CARDINALITY_VIOLATION"
    MISSING_REQUIRED_SOURCE_FACT = "MISSING_REQUIRED_SOURCE_FACT"
    DEFAULT_APPLIED = "DEFAULT_APPLIED"
    DERIVATION_PENDING = "DERIVATION_PENDING"
    OPTIONAL_OMISSION = "OPTIONAL_OMISSION"
    ...
    GRAPH_MAPPING_UNSUPPORTED = "GRAPH_MAPPING_UNSUPPORTED"
